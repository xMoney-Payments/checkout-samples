import { CardHolderVerificationResult } from "../checkout.types";
 ...
 */
export interface XMoneyCardElementsConfig extends XMoneyBaseConfig {
  /**
 ...
 */
export interface XMoneyCardElementsInstance extends XMoneyBaseInstance {
  /**
